...
namespace RogueLauncher.Rewrite
{
    ...
    public class ProjectileManager
    {
        ...
        [Rewrite]
        public List<RogueAPI.Projectiles.ProjectileObj> ActiveProjectileList { get { return m_projectilePool.ActiveObjsList; } }
        ...
        //[Obfuscation(Exclude = true), Rewrite(action: RewriteAction.Add)]
        //public IEnumerable<RogueAPI.Projectiles.ProjectileObj> GetActiveProjectiles()
        //{
        //    return m_projectilePool.ActiveObjsList.ToArray();
        //}
